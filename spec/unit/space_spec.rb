...
describe Spaces do
  describe '.all' do
    it 'returns all spaces' do
      ...
      connection.exec("INSERT INTO spaces (name, des, price) VALUES ('Blessing Apartment', 'Beautiful three bedroom house', '500');")
...
describe '.create' do
  it 'creates a new space' do
    spaces = Spaces.create(name: 'Tosin Bed & Breakfast', des: 'Beautiful all in one house', price: '300').first
